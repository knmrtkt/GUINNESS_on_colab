...
parser.add_argument('--trainpathfile', '-p', type=str, default='./trainlist.txt',
                        help='Train Image File List (test file)')
parser.add_argument('--testpathfile', '-q', type=str, default='./testlist.txt',
                        help='Test Image File List (test file)')
...
print("[INFO] TRAIN IMAGE PATH FILE %s" % args.trainpathfile)
print("[INFO] TEST IMAGE PATH FILE %s" % args.testpathfile)
...
## train
with open(args.trainpathfile, mode='r') as f:
	lines2 = f.readlines()
...
with open(args.testpathfile, mode='r') as f:
	lines2 = f.readlines()
